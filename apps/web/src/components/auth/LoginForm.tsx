  ...
  return (
    <div className="bg-[#151815] border border-[#242924] rounded-[2.5rem] shadow-2xl overflow-hidden">
      <div className="p-10 flex flex-col items-center">
        ...
        <h1 className="text-3xl font-semibold text-[#e2e8e0] mb-2 tracking-tight">OmniNote</h1>
        <p className="text-[#7a634a] text-sm mb-10 text-center font-medium">Welcome back to your sanctuary.</p>
        ...
        <form onSubmit={onSubmit} className="w-full space-y-6">
          ...
          <Button
            type="submit"
            disabled={isLoading}
            className="w-full h-12 bg-[#4a6741] hover:bg-[#5a7d4f] text-[#0f110f] font-bold rounded-xl transition-all shadow-lg shadow-[#4a6741]/10 active:scale-[0.98] disabled:opacity-70"
          >
      ...
      <div className="bg-[#1a1f1a]/50 p-6 flex justify-center border-t border-[#242924]">
        <p className="text-sm text-[#7a634a]">
          ...
          <Link href="/signup" className="text-[#4a6741] font-semibold hover:text-[#5a7d4f] transition-colors ml-1">
            Sign up
          </Link>
        </p>
      </div>
